...
Este relatório apresenta, de forma direta e objetiva, o fluxo básico de trabalho com Git e GitHub usando as imagens fornecidas como referência. O processo envolve criar um repositório remoto, editar arquivos, registrar alterações com *commits*, criar branches e clonar o projeto para edição local no VS Code.
...
<tr>
<td width="50%">
<img src="media/image1.png" alt="Tela de criação de um novo repositório no GitHub"><br>
<strong>Imagem 1:</strong> tela de criação de um novo repositório.
</td>
<td width="50%">
<img src="media/image2.png" alt="Repositório criado no GitHub"><br>
...
<tr>
<td width="50%">
<img src="media/image3.png" alt="Área de envio de arquivo no GitHub"><br>
<strong>Imagem 3:</strong> área para adicionar arquivos ao repositório.
</td>
<td width="50%">
<img src="media/image4.png" alt="Commit de novo arquivo no GitHub"><br>
...
## 2. Edição de conteúdo no GitHub
...
<tr>
<td width="50%">
<img src="media/image5.png" alt="Arquivo aberto no editor web do GitHub"><br>
<strong>Imagem 5:</strong> arquivo aberto no editor do GitHub.
</td>
<td width="50%">
<img src="media/image6.png" alt="Conteúdo alterado no GitHub"><br>
...
<tr>
<td width="50%">
<img src="media/image7.png" alt="Janela de commit no GitHub"><br>
<strong>Imagem 7:</strong> janela de commit com mensagem e descrição.
</td>
<td width="50%">
<img src="media/image8.png" alt="Confirmação de alteração no GitHub"><br>
...
<tr>
<td width="50%">
<img src="media/image9.png" alt="Alteração registrada no repositório"><br>
<strong>Imagem 9:</strong> alteração registrada no histórico do repositório.
</td>
<td width="50%">
<img src="media/image10.png" alt="Nova edição com commit"><br>
...
## 3. Criação e alteração de branch
...
<tr>
<td width="50%">
<img src="media/image11.png" alt="Tela de branches no GitHub"><br>
<strong>Imagem 11:</strong> tela de branches do repositório.
</td>
<td width="50%">
<img src="media/image12.png" alt="Criação de nova branch"><br>
...
<tr>
<td width="50%">
<img src="media/image13.png" alt="Lista de branches"><br>
<strong>Imagem 13:</strong> lista de branches após a criação do novo ramo.
</td>
<td width="50%">
<img src="media/image14.png" alt="Branch selecionada no repositório"><br>
...
<tr>
<td width="50%">
<img src="media/image15.png" alt="Menu de troca de branch"><br>
<strong>Imagem 15:</strong> menu usado para alternar entre branches.
</td>
<td width="50%">
<img src="media/image16.png" alt="Histórico da branch"><br>
...
<tr>
<td width="50%">
<img src="media/image17.png" alt="Comparação entre branches"><br>
<strong>Imagem 17:</strong> comparação ou integração de alterações entre branches.
</td>
<td width="50%">
<img src="media/image18.png" alt="Comandos de branch no terminal"><br>
...
## 4. Clonagem do repositório no VS Code
...
<tr>
<td width="50%">
<img src="media/image19.png" alt="VS Code antes da clonagem"><br>
<strong>Imagem 19:</strong> VS Code aberto para iniciar a clonagem.
</td>
<td width="50%">
<img src="media/image20.png" alt="Comando de clonagem no VS Code"><br>
...
<tr>
<td width="50%">
<img src="media/image21.png" alt="Projeto aberto no VS Code"><br>
<strong>Imagem 21:</strong> projeto aberto localmente após a clonagem.
</td>
<td width="50%">
<img src="media/image22.png" alt="Terminal mostrando processo Git"><br>
...
<tr>
<td width="50%">
<img src="media/image23.png" alt="Código sendo editado no VS Code"><br>
<strong>Imagem 23:</strong> código sendo editado no VS Code.
</td>
<td width="50%">
<img src="media/image24.png" alt="Terminal do VS Code com comandos Git"><br>
...
As imagens demonstram um ciclo completo de trabalho com Git e GitHub. O processo começa com a criação do repositório, passa pela edição de conteúdo e pelo registro de commits, avança para o uso de branches e termina com a clonagem do projeto para edição local no VS Code.

Esse fluxo melhora a organização do projeto, reduz riscos de perda de arquivos e permite acompanhar a evolução do código com clareza. A branch principal permanece mais protegida, enquanto branches secundárias podem ser usadas para testes, correções e novas funcionalidades.

Em resumo, Git e GitHub permitem trabalhar com versões de forma mais segura, rastreável e organizada, evitando práticas confusas como múltiplas cópias manuais do mesmo projeto.
